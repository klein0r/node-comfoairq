...
class ComfoAirQ extends events {
    constructor(options) {
        ...
        this._settings = {
            'pin'      : options.pin,
            'uuid'     : Object.prototype.hasOwnProperty.call(options, 'uuid') ? Buffer.from(options.uuid, 'hex') : undefined,
            'device'   : options.device,
            'comfoair' : options.comfoair,
            'comfouuid': Object.prototype.hasOwnProperty.call(options, 'comfouuid') ? Buffer.from(options.comfouuid, 'hex') : undefined,
